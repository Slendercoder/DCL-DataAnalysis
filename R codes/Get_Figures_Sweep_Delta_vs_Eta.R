...
# head(df1)
df2 = read.csv("out_Delta10-Eta0.5.csv")
df2$Exp <- as.character("10")
# head(df2)
df3 = read.csv("out_Delta20-Eta0.5.csv")
df3$Exp <- as.character("20")
# head(df3)
...
# Eta = 0.8
###############################################
df1 = read.csv("out_Delta0-Eta0.8.csv")
df1$Exp <- as.character("0.5")
# head(df1)
df2 = read.csv("out_Delta10-Eta0.8.csv")
df2$Exp <- as.character("10")
# head(df2)
df3 = read.csv("out_Delta20-Eta0.8.csv")
df3$Exp <- as.character("20")
# head(df3)
...
df1$Exp <- as.character("0")
# head(df1)
df2 = read.csv("out_Delta10-Eta1.csv")
df2$Exp <- as.character("10")
# head(df2)
df3 = read.csv("out_Delta20-Eta1.csv")
df3$Exp <- as.character("20")
# head(df3)
...
expTex = TeX('$bias_{RS}=1$, $\\alpha{=}150$, $\\beta{=}500$, $\\gamma{=}0.98$, $\\epsilon{=}0.3$, $\\zeta{=}0.3$')
