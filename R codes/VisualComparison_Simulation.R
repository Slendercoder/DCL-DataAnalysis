...
# 100 dyads simulated
###############################################
df1 = read.csv("../Python Codes/Sweeps/sim200_1.csv")
df1$Exp <- as.character("1")
head(df1)
df2 = read.csv("../Python Codes/Sweeps/sim200_2.csv")
df2$Exp <- as.character("2")
head(df2)
df3 = read.csv("../Python Codes/Sweeps/sim200_3.csv")
df3$Exp <- as.character("3")
head(df3)
df4 = read.csv("../Python Codes/Sweeps/sim200_4.csv")
df4$Exp <- as.character("4")
head(df4)
df5 = read.csv("../Python Codes/Sweeps/sim200_5.csv")
df5$Exp <- as.character("5")
head(df5)
...
grid.arrange(g1, g5, g10, g50, g100, g200,
             nrow = 3,
