...
# Epsilon = 0.3
###############################################
df1 = read.csv("out_Epsilon0.3-Zeta0.1.csv")
df1$Exp <- as.character("0.1")
# head(df1)
df2 = read.csv("out_Epsilon0.3-Zeta0.2.csv")
df2$Exp <- as.character("0.2")
# head(df2)
df3 = read.csv("out_Epsilon0.3-Zeta0.3.csv")
df3$Exp <- as.character("0.3")
# head(df3)
...
df$Exp <- factor(df$Exp, levels = c('0.1', '0.2', '0.3'))
...
# Epsilon = 0.5
###############################################
df1 = read.csv("out_Epsilon0.5-Zeta0.1.csv")
df1$Exp <- as.character("0.1")
# head(df1)
df2 = read.csv("out_Epsilon0.5-Zeta0.2.csv")
df2$Exp <- as.character("0.2")
# head(df2)
df3 = read.csv("out_Epsilon0.5-Zeta0.3.csv")
df3$Exp <- as.character("0.3")
# head(df3)
...
# Epsilon = 0.9
###############################################
df1 = read.csv("out_Epsilon0.9-Zeta0.1.csv")
df1$Exp <- as.character("0.1")
# head(df1)
df2 = read.csv("out_Epsilon0.9-Zeta0.2.csv")
df2$Exp <- as.character("0.2")
# head(df2)
df3 = read.csv("out_Epsilon0.9-Zeta0.3.csv")
df3$Exp <- as.character("0.3")
# head(df3)
...
expTex = TeX('$bias_{RS}=0$, $\\alpha{=}150$, $\\beta{=}500$, $\\gamma{=}0.98$, $\\delta{=}0$')
