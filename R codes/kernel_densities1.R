...
# head(df1)
df2 = read.csv("out_Delta0.5-Zeta0.csv")
df2$Exp <- as.character("0.5")
# head(df2)
df3 = read.csv("out_Delta1-Zeta0.csv")
df3$Exp <- as.character("1")
# head(df3)
df4 = read.csv("out_Delta1.5-Zeta0.csv")
df4$Exp <- as.character("1.5")
# head(df3)
...
df$Exp <- factor(df$Exp, levels = c('0', '0.5', '1', '1.5'))
...
df1$Exp <- as.character("0")
# head(df1)
df2 = read.csv("out_Delta0.5-Zeta0.1.csv")
df2$Exp <- as.character("0.5")
# head(df2)
df3 = read.csv("out_Delta1-Zeta0.1.csv")
df3$Exp <- as.character("1")
# head(df3)
df4 = read.csv("out_Delta1.5-Zeta0.1.csv")
df4$Exp <- as.character("1.5")
# head(df4)
