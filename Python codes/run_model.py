...
def data_for_confusion_matrix(gameParameters, N = 10):
    ...
    for n in range(N):
        ...
        data_conf_mtrx(gameParameters, modelParameters, 'MB', n+10)
        modelParameters = random_pars_WSLSmodel()
        data_conf_mtrx(gameParameters, modelParameters, 'WS', n+10)
        modelParameters = random_pars_FRAmodel()
        data_conf_mtrx(gameParameters, modelParameters, 'FR', n+10)
