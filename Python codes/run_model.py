...
def standard_simulation(gameParameters, modelParameters):
    ...
    print("\n")
    print('--- Player 2 ----')
    print('wALL: ', modelParameters[11])
    print('wNOTHING: ', modelParameters[12])
    print('wLEFT: ', modelParameters[13])
    print('wIN: ', modelParameters[14])
    print('alpha: ', modelParameters[15])
    print('beta: ', modelParameters[16])
    print('gamma: ', modelParameters[17])
    print('delta: ', modelParameters[18])
    print('epsilon: ', modelParameters[19])
    print('zeta: ', modelParameters[20])
    print('eta: ', modelParameters[21])
    print("\n")
    print("****************************")
